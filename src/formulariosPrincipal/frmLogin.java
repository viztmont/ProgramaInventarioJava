...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        login.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(104, 0, 0)));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        String nombreclave, nombref = "", clavef = "";
        ...
        try {
            ...
            while (rs.next()) {
                nombref = rs.getString("nombreuser");
                clavef = rs.getString("clave");
            }
        } catch (SQLException ex) {
            Logger.getLogger(frmHome.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (nombref.equals(txtUser.getText()) && clavef.equals(txtPwd.getText())) {
